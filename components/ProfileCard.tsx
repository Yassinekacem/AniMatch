...
// Define a Checkbox component if not already defined
...
const ProfileCard = ({ animal, onDelete, onUpdate }: { animal: animalType; onDelete: (id: number) => void; onUpdate: () => void }) => {
  ...
  const updateAnimal = async () => {
    try {
      await axios.put(`http://localhost:3000/api/animals/${animal.id}`, formData);
  ...
  return (
    <div className='flex items-center justify-between w-full h-[110px] bg-white rounded-lg border border-gray-200 shadow-md p-4'>
      ...
      <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
          ...
          <DialogContent className="sm:max-w-[600px] max-h-[100vh] overflow-y-auto bg-white">                        <DialogHeader>
            ...
            <div className="grid gap-4 py-8">
              ...
              <div className="grid grid-cols-4 items-center gap-4">
                <Label htmlFor="vaccinated" className="text-right">
                  Vaccinated
                </Label>
                <Checkbox
                  id="vaccinated"
              ...
              <div className="grid grid-cols-4 items-center gap-4">
                <Label htmlFor="trained" className="text-right">
                  Trained
                </Label>
                <Checkbox
                  id="trained"
              ...
              <div className="grid grid-cols-4 items-center gap-4">
                <Label htmlFor="friendly" className="text-right">
                  Friendly
                </Label>
                <Checkbox
                  id="friendly"
