  ...
  return (
    <div className='flex items-center justify-between w-full h-[110px] bg-white rounded-lg border border-gray-200 shadow-md p-4'>
        <div className='flex gap-4 items-center'>
            <Image src="/images/dog.jpeg" alt="Image" width={150} height={150} className='rounded-full w-20 h-20 object-cover' />
            <div className='flex flex-col'>
                <span className='font-semibold text-lg text-gray-800'>Black</span>
                <span className='text-gray-500 text-sm'>Age: 5 years, Gender: Male</span>
            </div>
        </div>
