...
const Comments = ({ petId }: CommentsProps) => {
  ...
  const getAnimalComments = useCallback(async () => {
    try {
      const response = await axios.get(`https://api-withdrizzle-orm-9e8n-jq5l35l9g-yassinekacems-projects.vercel.app/api/comments/${petId}`);
  ...
  const AddComment = async () => {
    try {
      const response = await axios.post("https://api-withdrizzle-orm-9e8n-jq5l35l9g-yassinekacems-projects.vercel.app/api/comments", {
